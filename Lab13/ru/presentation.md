...
![Выполнение Работы (mcedit)](1.1.jpg)


![Выполнение Работы (вывод)](1.2.jpg)

## Выполнение Работы
2. Реализовать команду man с помощью командного файла.

![Выполнение Работы(mcedit)](2.1.jpg)


![Выполнение Работы (вывод)](2.3.jpg)

## Выполнение Работы
3. Используя встроенную переменную $RANDOM, напишите командный файл, генерирующий случайную последовательность букв латинского алфавита.

![Выполнение Работы(mcedit)](3.1.jpg)


![Выполнение Работы (вывод)](3.2.jpg)
